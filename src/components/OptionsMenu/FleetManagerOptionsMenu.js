...
class FleetManagerOptionsMenuView extends Component {
    ...
    gotoProfile = () => {
        this.hideBottomNavigationView();
        this.props.navigation.navigate("FleetManagerProfilePage");
    }
...
export default withNavigation(FleetManagerOptionsMenuView);