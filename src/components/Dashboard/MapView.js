...
// create a component
class MapViewCard extends React.Component {
            ...
            <View style={styles.bannerCard}>
                ...
                <View>
                    <TouchableOpacity
                        ...
                        <Text style={styles.findText}>Find fuel stations near you <Icon name={'arrow-forward'} color="#380507" size={12} /></Text>
                    </TouchableOpacity>
                </View>
            </View>
        );
...
export default withNavigation(MapViewCard);