...
// create a component
class VehicleInfoDetailsView extends React.Component {
    ...
    renderHeader = () => {
        return (
            <>
                ...
                <Text style={styles.mainText}>Recent Vehicle Transactions</Text>
...
export default withNavigation(VehicleInfoDetailsView);