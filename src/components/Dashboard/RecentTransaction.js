...
import FuelPercentageCard from './FuelPercentage';
import MapView from './MapView';

const win = Dimensions.get('window');

// create a component
class RecentTransactionView extends React.Component {
    ...
    renderHeader = () => {
        return (
            ...
            // />
            <>
                <View style={styles.profileContainer} key={objectClass.randomString()}>
                ...
                <View key={objectClass.randomString()}>
                    <FuelPercentageCard parent="Purchase" navigation={this.props.navigation} />
                </View>
                ...
                <View style={{
                    ...
                    <Text style={styles.mainText}>Recent Transactions</Text>
...
export default withNavigation(RecentTransactionView);