...
class MultipleVoucherStatusView extends Component {
    ...
    render() {
        return (
            ...
            <Modal style={styles.modalContainer}
                ...
                <Text style={styles.modalTxt}>Your payment has been processed successfully</Text>
...
export default withNavigation(MultipleVoucherStatusView);