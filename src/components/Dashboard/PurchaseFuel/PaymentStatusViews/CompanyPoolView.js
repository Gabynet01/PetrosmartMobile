...
class CompanyPoolStatusView extends Component {
    ...
    render() {
        return (
            ...
            <Modal style={styles.modalContainer}
                ...
                />
                <Text style={styles.modalTxt}>Payment submitted to your Fleet manager for Approval</Text>
...
export default withNavigation(CompanyPoolStatusView);