...
class VehicleListView extends React.Component {
    ...
    renderItem = ({ item }) => (
        ...
        <ListItem titleNumberOfLines={1} onPress={this.viewDetails.bind(this, item)} style={styles.listItemDiv}>
            ...
            <View style={styles.listContentView}>
                ...
                <Text numberOfLines={1} style={styles.titleStyle}>{objectClass.toTitleCase("Toyota Corolla")}</Text>
    ...
    renderHeader = () => {
        return (
            <>
                <Text style={styles.mainText}>Vehicle List</Text>
    ...
    viewDetails(rowData) {
        this.props.navigation.navigate('VehicleInfoView', { listItemData: rowData });
    }
...
export default withNavigation(VehicleListView);