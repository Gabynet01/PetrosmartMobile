...
class FeedBackStatusView extends Component {
    ...
    render() {
        return (
            ...
            <Modal style={styles.modalContainer}
                ...
                <Text style={styles.modalTxt}>Your feedback was submitted successfully. Thank You</Text>

                <TouchableOpacity style={styles.solidButtonContainer}
                    onPress={() => this.toggleModal()}>
                    <Text style={styles.solidButtonText}>Back to Profile</Text>
                </TouchableOpacity>
...
export default withNavigation(FeedBackStatusView);