...
class StationListView extends React.Component {
    ...
    renderItem = ({ item }) => (
        ...
        <ListItem titleNumberOfLines={1} onPress={this.viewDetails.bind(this, item)} style={styles.listItemDiv}>
            ...
            <View style={styles.listContentView}>
                <Text numberOfLines={1} style={styles.titleStyle}>{objectClass.toTitleCase(item.StationName)}</Text>
                <Text numberOfLines={1} style={styles.subTitleStyle}>{objectClass.toTitleCase(item.StationAddress)}</Text>
                ...
                {item.payment_code_status.toUpperCase() == "INACTIVE" ? (
                    <View style={styles.footerView}>
                        ...
                        <Badge
                            value={"Active"}
                            badgeStyle={{ backgroundColor: '#E8FAE5', marginTop: -60 }}
                ...
                {item.payment_code_status.toUpperCase() == "ACTIVE" ? (
                    <View style={styles.footerView}>
                        ...
                        <Badge
                            value={"InActive"}
                            badgeStyle={{ backgroundColor: '#FEE6E1', marginTop: -60 }}
                ...
                <View style={{
                    ...
                    {this.state.locationSelected ? (
                        <View style={styles.mainButtonContainer}>
                            <TouchableOpacity style={styles.mainButton}
                                ...
                                <Text style={styles.mainButtonText}>Location</Text>
                            </TouchableOpacity>
                        </View>
                    ) : null}
                    ...
                    {this.state.locationNotSelected ? (
                        <View style={styles.otherButtonContainer}>
                            <TouchableOpacity style={styles.otherButton}
                                onPress={() => this.onLocationPress()}>
                                <Text style={styles.otherButtonText}>Location</Text>
                            </TouchableOpacity>
                        </View>
                    ) : null}
                    ...
                    {this.state.vendorSelected ? (
                        <View style={styles.mainButtonContainer}>
                            <TouchableOpacity style={styles.mainButton}
                                ...
                                <Text style={styles.mainButtonText}>Vendor</Text>
                            </TouchableOpacity>
                        </View>
                    ) : null}

                    {this.state.vendorNotSelected ? (
                        <View style={styles.otherButtonContainer}>
                            <TouchableOpacity style={styles.otherButton}
                                onPress={() => this.onVendorPress()}>
                                <Text style={styles.otherButtonText}>Vendor</Text>
                            </TouchableOpacity>
                        </View>
                    ) : null}
    ...
    viewDetails(rowData) {
        this.props.navigation.navigate('StationInfoView', { listItemData: rowData });
    }
    ...
    onVendorPress() {
        this.searchFilterFunction("Vendor");
        this.setState(
            {
                allSelected: false,
                allNotSelected: true,
...
export default withNavigation(StationListView);